...
Tip: For at ændre baggrundsfarven  kan I bruge \ttpy{rect(0, 0, 400, 400)}, som I
...
\noindent
Tilføj nu følgende inde i \ttpy{draw}-funktionen:
\begin{javascript}
var eyeSize = 15;
...
\item Tegn en finne på siden af fisken vha. triangle()-kommandoen\footnote{Læs om \ttpy{triangle()} i dokumentationen: \url{https://p5js.org/reference/##/p5/triangle}}
...
\noindent
Kald alle funktionerne i \ttpy{draw}-funktionen. For eksempel:
...
\tcbsubtitle{BEMÆRK!}
Når man bruger \ttpy{setup}/\ttpy{draw}, er det
...
\ttpy{keyPressed}\footnote{Dokumentation: \url{https://p5js.org/reference/##/p5/keyPressed}}. Prøv at tilføje følgende til tegneprogrammet:
...
\begin{itemize}
\item Opret en ny global variabel \ttpy{gameState = "RUNNING"}
